...
function Eff_dens( j, i)
  ...
  zcord = 0.25*(cord(j,i,2)+cord(j+1,i,2)+cord(j,i+1,2)+cord(j+1,i+1,2))&
     +    0.25*(cord(1,nx/2,2)+cord(2,nx/2,2)+cord(1,nx/2+1,2)+cord(2,nx/2+1,2))
...
!!$      Eff_dens = dens
      ...
      do k = 1, nphase
          ...
          dens = den(k) * ( 1 - alfa(k)*tmpr + beta(k)*press )
      !   if (zcord.ge.-6e3.and.tmpr.ge.1100) then
...
! different coduct !Liu                                                                                                                      
! do i = 1,nx-1                                                                                                                                
 ! do  j = 1,nz-1                                                                                                                              
 !   tmpr = 0.25*(temp(j,i)+temp(j+1,i)+temp(j,i+1)+temp(j+1,i+1))                                                                             
 !   yc = 0.25*(cord(j,i,2)+cord(j+1,i,2)+cord(j,i+1,2)+cord(j+1,i+1,2))                                                                       
 ! if (tmpr.lt.600.and.yc.lt.7e3) then                                                                                                         
 !  Eff_conduct = Eff_conduct*4.                                                                                                               
 ! else                                                                                                                                        
 !  Eff_conduct = Eff_conduct                                                                                                                  
! endif                                                                                                                                        
!end do                                                                                                                             
!end do 
