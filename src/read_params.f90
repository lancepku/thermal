...
do i = 1, nphase 
    ...
    read(4,*) irheol(i),visc(i),den(i),alfa(i),beta(i),pln(i),acoef(i),eactiv(i),rl(i),rm(i), &
            plstrain1(i),plstrain2(i),plstrain3(i),fric1(i),fric2(i),fric3(i),cohesion1(i), &
            cohesion2(i),cohesion3(i), dilat1(i),dilat2(i),dilat3(i), &
...
!call ReadIntrusions()  ! - see user_ab.f90
  ...
  call ReadHydro()       ! - see user_liu.f90
